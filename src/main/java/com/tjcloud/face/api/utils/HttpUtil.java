...
public class HttpUtil {
	...
	private HttpPost fillHeaders(HttpPost httpPost) {
		httpPost.setHeader("Accept-Encoding", "gzip, deflate, br");
		httpPost.setHeader("Accept-Language", "zh-CN,zh;q=0.8");
		httpPost.setHeader("Content-Type", "application/x-www-form-urlencoded; charset=utf-8");
		httpPost.setHeader("User-Agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.81 Safari/537.36");
		return httpPost;
	}
     ...
     */
	@SuppressWarnings("unused")
	public String sendPost(String url, JSONObject requestBody, Map<String, String> urlParams, Boolean accessToken) {
        ...
        HttpPost httppost = new HttpPost(setUrl(url, urlParams, accessToken));
