...
/**
 * 闸机开门指令数据(stadium_item_dooropen_log)
 * @author auto bin.yin 2019.03.17
 */
public class StadiumItemDooropenLog extends AbstractEntity {
	private static final long serialVersionUID = 1552826407203L;
	...
	private Integer openDuration; //开门时长（单位秒）
